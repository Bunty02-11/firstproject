                            ...
                            <div className="col-md-12 pt-5">
                                ...
                                <div id="js-grid-mosaic" className="cbp cbp-l-grid-mosaic">
                                    <div className="cbp-item web logo">
                                        <a
                                            href="https://megaone.acrothemes.com/creative-startup/img/p1.jpg"
                                            className="cbp-caption cbp-lightbox"
                                            data-title="Workout Buddy<br>by Tiberiu Neamu"
                                        >
                                            <div className="cbp-caption-defaultWrap">
                                                <img
                                                    src="https://megaone.acrothemes.com/creative-startup/img/p1.jpg"
                                                    alt="img"
                                                />
                                            </div>
                                    ...
                                    <div className="cbp-item mobile web">
                                        <a
                                            href="https://megaone.acrothemes.com/creative-startup/img/p2.jpg"
                                            className="cbp-caption cbp-lightbox"
                                            data-title="Workout Buddy<br>by Tiberiu Neamu"
                                        >
                                            <div className="cbp-caption-defaultWrap">
                                                <img
                                                    src="https://megaone.acrothemes.com/creative-startup/img/p2.jpg"
                                                    alt="img"
                                                />
                                            </div>
                                            <div className="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    ...
                                    <div className="cbp-item print logo development web mobile">
                                        <a
                                            href="https://megaone.acrothemes.com/creative-startup/img/p3.jpg"
                                            className="cbp-caption cbp-lightbox"
                                            data-title="Workout Buddy<br>by Tiberiu Neamu"
                                        >
                                            <div className="cbp-caption-defaultWrap">
                                                <img
                                                    src="https://megaone.acrothemes.com/creative-startup/img/p3.jpg"
                                                    alt="img"
                                                />
                                            </div>
                                            <div className="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
                                    ...
                                    <div className="cbp-item logo development">
                                        <a
                                            href="https://megaone.acrothemes.com/creative-startup/img/p4.jpg"
                                            className="cbp-caption cbp-lightbox"
                                            data-title="Workout Buddy<br>by Tiberiu Neamu"
                                        >
                                            <div className="cbp-caption-defaultWrap">
                                                <img
                                                    src="https://megaone.acrothemes.com/creative-startup/img/p4.jpg"
                                                    alt="img"
                                                />
                                            </div>
                                            <div className="cbp-caption-activeWrap portfolio-hover-effect d-flex align-items-end">
