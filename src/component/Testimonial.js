                                        ...
                                        <div className="testimonial-box owl-carousel owl-theme">
                                            <div className="item text-center">
                                                ...
                                                <p className="text">
                                                    ...
                                                    Fusce vitae egestas mi, vel dapibus diam. Mauris
                                                    malesuada, nisl non rutrum commodo, sem magna laoreet
                                                    tellus, eu euismod dolor enim et mi. In at tempor purus.
                                                </p>
                                                <div className="img-holder">
                                                    <img src="https://megaone.acrothemes.com/creative-startup/img/test1.jpg" />
                                                </div>
                                            ...
                                            <div className="item text-center">
                                                ...
                                                <div className="img-holder">
                                                    <img src="https://megaone.acrothemes.com/creative-startup/img/test2.jpg" />
                                                </div>
